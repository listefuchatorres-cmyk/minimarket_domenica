...
$lista = mysqli_query($conexion, "SELECT * FROM productos WHERE categoria = 'tecnologia' ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Artículos Tecnológicos</title>
...
<div class="container">
    <h2 class="section-title">🎧 Artículos Tecnológicos</h2>
    <div class="cards">
        <?php if(empty($lista)): ?>
