...
$lista = mysqli_query($conexion, "SELECT * FROM productos WHERE categoria = 'ropa' ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div class="container">
    <h2 class="section-title">👕 Ropa y Calzado</h2>
    <div class="cards">
        <?php if(empty($lista)): ?>
