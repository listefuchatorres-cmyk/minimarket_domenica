...
$lista = mysqli_query($conexion, "SELECT * FROM productos WHERE categoria = 'lencería' ORDER BY id DESC");
?>
...
<head>
    ...
    <title>Lencería - MiniMarket Domenica</title>
...
<div class="container">
    <h2 class="section-title">👙 Lencería y Trajes de Baño</h2>
    <div class="cards">
        <?php if(empty($lista)): ?>
