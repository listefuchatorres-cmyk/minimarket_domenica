...
$lista = mysqli_query($conexion, "SELECT * FROM productos WHERE categoria = 'maquillaje' ORDER BY id DESC");
?>
...
<head>
    ...
    <title>Maquillaje - MiniMarket Domenica</title>
...
<div class="container">
    <h2 class="section-title">💄 Maquillaje y Belleza</h2>
    <div class="cards">
        <?php if(empty($lista)): ?>
