...
$lista = mysqli_query($conexion, "SELECT * FROM productos WHERE categoria = 'hogar' ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Artículos para el Hogar</title>
...
<div class="container">
    <h2 class="section-title">🏠 Artículos para el Hogar</h2>
    <div class="cards">
        <?php if(empty($lista)): ?>
